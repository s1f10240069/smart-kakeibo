...
export const getSyncFile = async (token) => {
  ...
  const res = await fetch(
    `https://www.googleapis.com/drive/v3/files?spaces=appDataFolder&q=${encodeURIComponent(query)}&orderBy=modifiedTime%20desc&pageSize=1&fields=files(id,name,modifiedTime)`,
